...
public interface ExtendedPrivateTransaction {
  /**
  ...
  /**
   * The real value of the private arguments
   * 
   * @return privateArgs
   */
  Bytes getPrivateArgs();

  /**
   * The extended signature, commiting to private arguments
   * 
   * @return extSignaure
   */
  BigInteger getExtR();
